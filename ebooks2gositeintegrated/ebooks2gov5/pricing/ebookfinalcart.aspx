            ...
            <table id="tabEbook1" width="1000" border="1" bordercolor="#E1E1E1" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td colspan="5" align="right">
                        <asp:ImageButton ID="imgbtnback" runat="server" ImageUrl="../images/btnBack.jpg" PostBackUrl="~/ebooks2gov5/pricing/fileupload.aspx?ID=1" Width="117" Height="30" alt="edit" />
                        &nbsp; &nbsp;
