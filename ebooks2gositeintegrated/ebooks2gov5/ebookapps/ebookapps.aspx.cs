...
{
    public partial class ebookapps : System.Web.UI.Page
    {
        ...
        private void addtosession(DataTable dtsimpleebookappscart)
        {
            ...
            Session["simpleebookappsproductprice"] = roundofdecimalpoints(getproductprice((int)(bel.bel.prodcategory.simpleebookapps)));
