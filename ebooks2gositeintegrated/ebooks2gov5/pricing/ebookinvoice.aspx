<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ebookinvoice.aspx.cs" Inherits="eBooks2goV5.pricing.ebookinvoice" %>
        ...
        <div class="eb2g_invoice_page">
                ...
                <table width="500" border="1">
                    ...
                    <tr height="120">
                       <%-- <td>ABC Ltd<br />
                            ...
                            <br />
                            Kind Attn: </td>--%>
                         <td><asp:Label ID="lblebookinvoicecustomername" runat="server"></asp:Label><br />
                            <asp:Label ID="lblebookinvoicecustomeraddressone" runat="server"></asp:Label><br />
                            <asp:Label ID="lblebookinvoicecustomeraddresstwo" runat="server"></asp:Label><br />
                            <asp:Label ID="lblebookinvoicecustomercountry" runat="server"></asp:Label> - <asp:Label ID="lblebookinvoicecustomerzipcode" runat="server"></asp:Label>
                            <br />
                            <br />
                            <br />
                            Kind Attn: </td>
                    ...
                    <tr height="40">
                        <td><asp:Label ID="lblebookinvoicesigncustomername" runat="server"></asp:Label></td>
                    </tr>
                </table>
            </div>
            ...
            <div class="eb2g_invoice_details" align="right">
                <table width="350" border="1">
                    <tr align="center">
                        <td>Invoice No</td>
                        <td><asp:Label ID="lblebookinvoicenumber" runat="server"></asp:Label></td>
                    </tr>
                    <tr align="center">
                        <td>Date</td>
                        <td><asp:Label ID="lblebookinvoicedate" runat="server"></asp:Label></td>
                    </tr>
                    <tr align="center">
                        <td>Inv Amount</td>
                        <td>USD <asp:Label ID="lblebookinvoicetotalamount" runat="server"></asp:Label></td>
                    </tr>
                    <tr align="center">
                        <td>P.O. No</td>
                        <td><asp:Label ID="lblebookponumber" runat="server"></asp:Label></td>
                    </tr>
                    <tr align="center">
                        <td>Invoice Send to</td>
                        <td><asp:Label ID="lblebookinvoiceinvoicesendtocustomername" runat="server"></asp:Label></td>
                    </tr>
                    <tr align="center">
                        <td>Sales Person</td>
                        <td>NJ</td>
