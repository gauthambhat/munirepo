<%--we are currently using newebookapps(this page contains jquery calculation) page only we are not use the ebookapps and xebookapps--%>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="newebookapps.aspx.cs" Inherits="eBooks2goV5.ebookapps.newebookapps" %>
...
<!--    <div id="accordion">
   ...
   <asp:Panel ID="pnlSimple" runat="server">
                            ...
                            <div class="blueclock">
                                <div style="transform: rotate(0deg) scale(1, 1); display: block;" class="pendulum-parent">
                                    <div class="ebooks_discount" align="center">
                                        ...
                                        <ul>
                                            <li>Select any '
                                                <asp:Label ID="lblebookappssimplebookappsoffer1" class="simpleoffer1" runat="server"></asp:Label>
                                                ' products get
                                                <asp:Label ID="lblebookappssimplebookappsoffer1discount" class="simpleoffer1discount" runat="server"></asp:Label>
                                                Discount on base price' </li>
                                            <li>Select any '
                                                <asp:Label ID="lblebookappssimplebookappsoffer2" class="simpleoffer2" runat="server"></asp:Label>
                                                ' products get
                                                <asp:Label ID="lblebookappssimplebookappsoffer2discount"  class="simpleoffer2discount" runat="server"></asp:Label>
                                                Discount on base price'</li>
                                            <li>Select any '
                                                <asp:Label ID="lblebookappssimplebookappsoffer3" class="simpleoffer3" runat="server"></asp:Label>' products get
                                                <asp:Label ID="lblebookappssimplebookappsoffer3discount" class="simpleoffer3discount" runat="server"></asp:Label>
                                                Discount on base price'</li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="apps-box-content">
                            ...
                            <div class="eb2g_products_cost">
                                <div class="eb2g_PackageCost">
                                    ...
                                    <asp:TextBox ID="hdnebookappssimpleebookappspackagecost" class="simpletotalcost" runat="server" style="display:none;" ></asp:TextBox>
                                </div>
                        ...
                        <tr>
                            <td width="490">
                                ...
                                <span class="Customize_totalnumber">Upto
                                    <asp:Label ID="lblebookappssimpleebookappscustpages" class="simpleCustdefault"  runat="server"></asp:Label>
                                    pages are included in the base price.<br />
                                    &nbsp;&nbsp;&nbsp;Each Additonal pages be billed at. $<asp:Label ID="lblebookappssimpleebookappscustpagescost" class="simpleCustcost" runat="server"></asp:Label>
                                </span>
                            </td>
                            <td width="100" align="center">
                               <%-- <input type="text" />--%>
                                <asp:TextBox ID="txtebookappssimpleebookappscustpages" runat="server" class="simpleCustqty"></asp:TextBox>
    ...
    TargetControlID="txtebookappssimpleebookappscustpages" />
                            ...
                            <td><asp:Label ID="lblebookappssimpleebookappsadditionalpages" class="simpleCustadditional" runat="server"></asp:Label></td>
                            <td><asp:Label ID="lblebookappssimpleebookappsadditonalpagesunitcost" class="simpleCustadditionalunitcost" runat="server"></asp:Label>
                                <asp:TextBox ID="hdnebookappssimpleebookappsadditonalpagesunitcost" class="simpleCustadditionalunitcost" runat="server" style="display:none;"></asp:TextBox>
                            </td>
                            <td><asp:Label ID="lblebookappssimpleebookappsadditionaltotalcost" class="simpleCustadditionaltotalcost" runat="server"></asp:Label>
                                <asp:TextBox ID="hdnebookappssimpleebookappsadditionaltotalcost" class="simpleCustadditionaltotalcost" runat="server" style="display:none;"></asp:TextBox>
                            </td>
                        </tr>
  ...
  <asp:Panel ID="pnlComplex" runat="server">
                        ...
                        <div class="apps-box-content">
                            ...
                            <div class="eb2g_products_cost">
                                <div class="eb2g_PackageCost">
                                    ...
                                    <asp:TextBox ID="hdnebookappscomplexebookappspackagecost" class="complexpackagecost" style="display:none;" runat="server"></asp:TextBox>
                                </div>
                                <div class="eb2g_addtocart">
                                    <a href="#">
                                        <img src="images/addtocart.jpg" alt="" />
    ...
    TargetControlID="txtebookappscomplexebookappscustpages" />
                            ...
                            <td>
                                <asp:Label ID="lblebookappscomplexebookappsaddtionalpagesunitcost"  class="complexCustadditionalunitcost"  runat="server"></asp:Label>
                                <asp:TextBox ID="hdnebookappscomplexebookappsaddtionalpagesunitcost"  class="complexCustadditionalunitcost" style="display:none;" runat="server"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label ID="lblebookappscomplexebookappsadditionalpagestotalcost"  class="complexCustadditionaltotalcost" runat="server"></asp:Label>
                                <asp:TextBox ID="hdnebookappscomplexebookappsadditionalpagestotalcost"  class="complexCustadditionaltotalcost" style="display:none;" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td width="490">
    ...
    TargetControlID="txtebookappscomplexebookappscustanimationpages" />
                            ...
                            <td><asp:Label ID="lblebookappscomplexebookappsadditionalanimationpagesunitcost"  class="complexCustadditionalunitcost"  runat="server"></asp:Label>
                                <asp:TextBox ID="hdnebookappscomplexebookappsadditionalanimationpagesunitcost"  class="complexCustadditionalunitcost" style="display:none;"  runat="server"></asp:TextBox>
                            </td> 
                            <td><asp:Label ID="lblebookappscomplexebookappsadditionalanimationpagestotalcost"  class="complexCustadditionaltotalcost" runat="server"></asp:Label>
                                <asp:TextBox ID="hdnebookappscomplexebookappsadditionalanimationpagestotalcost"  class="complexCustadditionaltotalcost" style="display:none;" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                    <h3>Samples Application</h3>
  ...
  <asp:Panel ID="pnltxtbok" runat="server">
                            ...
                            <div class="eb2g_products_cost">
                                <div class="eb2g_PackageCost">
                                    ...
                                    <asp:TextBox ID="txtebookappsfortextbookspackagecost" class="textbookpackagecost" runat="server" ReadOnly="true"></asp:TextBox>
                                     <asp:TextBox ID="hdnebookappsfortextbookspackagecost" class="textbookpackagecost" runat="server"  style="display:none;"></asp:TextBox>
                                </div>
                                <div class="eb2g_addtocart">
                                    <a href="#">
                                        <img src="images/addtocart.jpg" alt="" />
    ...
    TargetControlID="txtebookappsfortextbookscustpages" />
                            ...
                            <td><asp:Label ID="lblebookappsfortextbooksadditionalpages" class="textbookCustadditional" runat="server"></asp:Label>

                            </td>
                            <td><asp:Label ID="lblebookappsfortextbooksadditionalpagesunitcost" class="textbookCustadditionalunitcost"  runat="server"></asp:Label>
                                 <asp:TextBox  ID="hdnebookappsfortextbooksadditionalpagesunitcost" class="textbookCustadditionalunitcost" style="display:none;"  runat="server"/>
                            </td>
                            <td><asp:Label ID="lblebookappsfortextbooksadditionalpagestotalcost" class="textbookCustadditionaltotalcost" runat="server"></asp:Label>
                                <asp:TextBox  ID="hdnebookappsfortextbooksadditionalpagestotalcost" class="textbookCustadditionaltotalcost" style="display:none;"  runat="server"/>
                            </td>
                        </tr>
                        <tr>
                            <td width="490">
    ...
    TargetControlID="txtebookappsfortextbookscustinteractiveandselfassessmentpages" />
                            ...
                            <td><asp:Label ID="lblebookappsfortextbooksadditionalinteractiveselfassessmentpages" class="textbookCustadditional" runat="server"></asp:Label>
                            </td>
                            <td><asp:Label ID="lblebookappsfortextbooksadditionalinteractiveselfassessmentunitcost" class="textbookCustadditionalunitcost" runat="server"></asp:Label>
                                 <asp:TextBox  ID="hdnebookappsfortextbooksadditionalinteractiveselfassessmentunitcost" class="textbookCustadditionalunitcost" style="display:none;" runat="server"/>
                            </td>
                            <td><asp:Label ID="lblebookappsfortextbooksadditionalinteractiveselfassessmenttotalcost" class="textbookCustadditionaltotalcost" runat="server"></asp:Label>
                                 <asp:TextBox  ID="hdnebookappsfortextbooksadditionalinteractiveselfassessmenttotalcost" class="textbookCustadditionaltotalcost" style="display:none;"  runat="server"/>
                            </td>
                        </tr>
                        <tr>
                            <td width="490">
    ...
    TargetControlID="txtebookappsfortextbookscustavelements" />
                            ...
                            <td>
                                <asp:Label ID="lblebookappstextbooksadditionalavelements" class="textbookCustadditional"  runat="server"></asp:Label>                               
                            </td>
                            <td>
                                <asp:Label ID="lblebookappstextbooksadditionalavelementsunitcost" class="textbookCustadditionalunitcost" runat="server"></asp:Label>
                                 <asp:TextBox  ID="hdnebookappstextbooksadditionalavelementsunitcost" class="textbookCustadditionalunitcost" style="display:none;"  runat="server"/>
                            </td>
                            <td><asp:Label ID="lblebookappstextbooksadditionalavelementstotalcost" class="textbookCustadditionaltotalcost" runat="server"></asp:Label>
                                 <asp:TextBox  ID="hdnebookappstextbooksadditionalavelementstotalcost" class="textbookCustadditionaltotalcost" style="display:none;" runat="server" />
                            </td>
                        </tr>
                    </table>
                    <h3>Samples Application</h3>
       ...
       <script>
        ...
        <script>
         ...
         <script>
          ...
          <%--Textbook apps jquery Calculation portion start--%>

        <%--script for count start--%>
         <script type="text/javascript">
             function textbookproductcount() {
                 var i = 0;
                 $("#pnlebookappsfortextbooksproducts input:checked").each(function () {
        ...
        <%--script for count complete--%>

        <%--checkbox change event start--%>
        <script type="text/javascript">
            $(".chktextbookproducts").change(function () {
                ebookappsfortextbookcalculation();

            });
         </script>
        <%--checkbox change event complete--%>

        <%-- products offers discount cost calculation start--%>
         <script>
             function textbookproductcost() {
                 var totproductcost = 0;
                 var count = textbookproductcount();
                 ...
                 //alert(totproductcost);

                 return totproductcost;
             }
        </script>
        <%--products offer discount cost calculation complete--%>
        ...
        <%--textbox key complete--%>

         <%--script for customization cost calculation start--%>
        <script>
            function gettextbookcustomisation() {
                var Customisationcost = 0
                var count = textbookproductcount();
                $('.textbook_customize_products tr').each(function (i, row) {
                    //alert('Hi');
                    var $row = $(row),
                     Custdefault = $row.find('.textbookCustdefault').html();
                    Custcost = $row.find('.textbookCustcost').html();
                    Custqty = $row.find('.txtbookqty').val();
                    Custadditional = $row.find('.textbookCustadditional').val();
                    Custadditionalunitcost = $row.find('.textbookCustadditionalunitcost').val();
                    if (!isNaN(parseInt($row.find('.txtbookqty').val()))) {
                        if (parseInt($row.find('.txtbookqty').val()) > parseInt($row.find('.textbookCustdefault').html())) {

                            $row.find('.textbookCustadditional').html(parseInt($row.find('.txtbookqty').val()) - parseInt($row.find('.textbookCustdefault').html()));
                            $row.find('.textbookCustadditionalunitcost').html($row.find('.textbookCustcost').html());
                            $row.find('.textbookCustadditionaltotalcost').html((parseInt($row.find('.txtbookqty').val()) - parseInt($row.find('.textbookCustdefault').html())) * parseFloat($row.find('.textbookCustcost').html()) * parseInt(count));
                            $row.find('.textbookCustadditionalunitcost').val($row.find('.textbookCustcost').html());
                            $row.find('.textbookCustadditionaltotalcost').val((parseInt($row.find('.txtbookqty').val()) - parseInt($row.find('.textbookCustdefault').html())) * parseFloat($row.find('.textbookCustcost').html()) * parseInt(count));
                            Customisationcost = parseFloat(Customisationcost) + parseFloat((parseInt($row.find('.txtbookqty').val()) - parseInt($row.find('.textbookCustdefault').html())) * parseFloat($row.find('.textbookCustcost').html()) * parseInt(count))
                        }
                        else {
                            $row.find('.textbookCustadditional').html('');
                            $row.find('.textbookCustadditionalunitcost').html('');
                            $row.find('.textbookCustadditionaltotalcost').html('');
                            $row.find('.textbookCustadditionalunitcost').val('');
                            $row.find('.textbookCustadditionaltotalcost').val('');
                        }
                ...
                return Customisationcost;
            }
        </script>
        <%--script for customization cost calculation complete--%>

        <%--script for ebooks apps for textbook calc start--%>
         <script type="text/javascript">
             function ebookappsfortextbookcalculation() {
                 var count = 0;
                 var productprice = 0;
                 var customisationprice = 0;
                 var cartprice = 0;
                 count = textbookproductcount();
                 if (count > 0) {
                     productprice = textbookproductcost();
                     customisationprice = gettextbookcustomisation();
                     cartprice = (parseFloat(productprice) + parseFloat(customisationprice)).toFixed(2);
                     $('.textbookpackagecost').val(cartprice);
                     $('#imgbtntextbook').prop('disabled', false);
                 }
                 else {
                     $('.textbookpackagecost').val('');
                     cleartextbookcustomizations();
                     $('#imgbtntextbook').prop('disabled', true);
                     $('input').val('');
                 }
             }
        </script>
        <%--script for ebooks apps for textbook calc complete--%>

        <%--script for to clear labels start--%>
        <script type="text/javascript">
            function cleartextbookcustomizations() {
                $('.textbook_customize_products tr').each(function (i, row) {
                    var $row = $(row);
                    $row.find('.textbookCustadditional').html('');
                    $row.find('.textbookCustadditionalunitcost').html('');
                    $row.find('.textbookCustadditionaltotalcost').html('');
                    $row.find('.txtbookqty').val('');
                });
            }
        </script>
        <%--script for to clear labels complete--%>

       <%--TextBook apps jquery calculation portion complete--%>


        <%--simple ebookapps jquery calculation portion start--%>
        ...
        <script type="text/javascript">
            $(".chksimpleproducts").change(function () {
                //ebookappsfortextbookcalculation();
                //complexproductcost();
                //complexebookappscalculation();
                //simpleproductcost();
                simpleebookappscalculation();
            });
         </script>
        <%--checkbox change event complete--%>
        ...
        <%--textbox key start--%>
        <script>
            jQuery('.simpleCustqty').on('keyup', function () {
                //txtbookcalculation();
                //alert("Hi");
                //getcomplexcustomisation();
                simpleebookappscalculation();
            });
        ...
        <%--textbox key complete--%>
          ...
          <%--script for customization cost calculation start--%>
        <script>
            function getsimplecustomisation() {
                var Customisationcost = 0
                var count = simpleproductcount();
                $('.simple_customize_products tr').each(function (i, row) {
                    //alert('Hi');
                    var $row = $(row),
                     Custdefault = $row.find('.simpleCustdefault').html();
                    Custcost = $row.find('.simpleCustcost').html();
                    Custqty = $row.find('.simpleCustqty').val();
                    Custadditional = $row.find('.simpleCustadditional').val();
                    Custadditionalunitcost = $row.find('.simpleCustadditionalunitcost').val();
                    if (!isNaN(parseInt($row.find('.simpleCustqty').val()))) {
                        if (parseInt($row.find('.simpleCustqty').val()) > parseInt($row.find('.simpleCustdefault').html())) {

                            $row.find('.simpleCustadditional').html(parseInt($row.find('.simpleCustqty').val()) - parseInt($row.find('.simpleCustdefault').html()));
                            $row.find('.simpleCustadditionalunitcost').html($row.find('.simpleCustcost').html());
                            $row.find('.simpleCustadditionaltotalcost').html((parseInt($row.find('.simpleCustqty').val()) - parseInt($row.find('.simpleCustdefault').html())) * parseFloat($row.find('.simpleCustcost').html()) * parseInt(count));
                            $row.find('.simpleCustadditionalunitcost').val($row.find('.simpleCustcost').html());
                            $row.find('.simpleCustadditionaltotalcost').val((parseInt($row.find('.simpleCustqty').val()) - parseInt($row.find('.simpleCustdefault').html())) * parseFloat($row.find('.simpleCustcost').html()) * parseInt(count));
                            Customisationcost = parseFloat(Customisationcost) + parseFloat((parseInt($row.find('.simpleCustqty').val()) - parseInt($row.find('.simpleCustdefault').html())) * parseFloat($row.find('.simpleCustcost').html()) * parseInt(count))
                        }
                        else {
                            $row.find('.simpleCustadditional').html('');
                            $row.find('.simpleCustadditionalunitcost').html('');
                            $row.find('.simpleCustadditionaltotalcost').html('');
                            $row.find('.simpleCustadditionalunitcost').val('');
                            $row.find('.simpleCustadditionaltotalcost').val('');
                        }
                ...
                //alert(Customisationcost);
                return Customisationcost;
            }
        </script>
        <%--script for customization cost calculation complete--%>

         <%--script for simple ebookapps calc start--%>
         <script type="text/javascript">
             function simpleebookappscalculation() {
                 var count = 0;
                 var productprice = 0;
                 var customisationprice = 0;
                 var cartprice = 0;
                 count = simpleproductcount();
                 if (count > 0) {
                     productprice = simpleproductcost();
                     customisationprice = getsimplecustomisation();
                     cartprice = (parseFloat(productprice) + parseFloat(customisationprice)).toFixed(2);
                     $('.simpletotalcost').val(cartprice);
                     $('#imgbtnsimpleproceed').prop('disabled', false);
                 }
                 else {
                     $('.simpletotalcost').val('');
                     clearsimplecustomizations();
                     $('#imgbtnsimpleproceed').prop('disabled', true);
                     $('input').val('');//clear the hidden values(any input type)
                 }
             }
        </script>
        <%--script for ebooks apps for textbook calc complete--%>
          ...
          <%--script for to clear labels start--%>
        <script type="text/javascript">
            function clearsimplecustomizations() {
                $('.simple_customize_products tr').each(function (i, row) {
                    var $row = $(row);
                    $row.find('.simpleCustadditional').html('');
                    $row.find('.simpleCustadditionalunitcost').html('');
                    $row.find('.simpleCustadditionaltotalcost').html('');
                    $row.find('.simpleCustqty').val('');
                });
            }
        </script>
        <%--script for to clear labels complete--%>

        <%--simple ebookapps jquery calculation portion complete--%>

        <%--complex ebookapps jquery calculation portion start--%>
        ...
        <%--products offer discount cost calculation complete--%>
         ...
         <%--textbox key start--%>
        <script>
            jQuery('.complexCustqty').on('keyup', function () {
                //txtbookcalculation();
                //alert("Hi");
                //getcomplexcustomisation();
                complexebookappscalculation();
        ...
        <%--textbox key complete--%>
         ...
         <%--script for customization cost calculation start--%>
        <script>
            function getcomplexcustomisation() {
                var Customisationcost = 0
                var count = complexproductcount();
                $('.complex_customize_products tr').each(function (i, row) {
                    //alert('Hi');
                    ...
                    if (!isNaN(parseInt($row.find('.complexCustqty').val()))) {
                        if (parseInt($row.find('.complexCustqty').val()) > parseInt($row.find('.complexCustdefault').html())) {
                            ...
                            $row.find('.complexCustadditionalunitcost').html($row.find('.complexCustcost').html());
                            $row.find('.complexCustadditionaltotalcost').html((parseInt($row.find('.complexCustqty').val()) - parseInt($row.find('.complexCustdefault').html())) * parseFloat($row.find('.complexCustcost').html()) * parseInt(count));
                            $row.find('.complexCustadditionalunitcost').val($row.find('.complexCustcost').html());
                            $row.find('.complexCustadditionaltotalcost').val((parseInt($row.find('.complexCustqty').val()) - parseInt($row.find('.complexCustdefault').html())) * parseFloat($row.find('.complexCustcost').html()) * parseInt(count));
                            Customisationcost = parseFloat(Customisationcost) + parseFloat((parseInt($row.find('.complexCustqty').val()) - parseInt($row.find('.complexCustdefault').html())) * parseFloat($row.find('.complexCustcost').html()) * parseInt(count))
                        }
                        else {
                            $row.find('.complexCustadditional').html('');
                            $row.find('.complexCustadditionalunitcost').html('');
                            $row.find('.complexCustadditionaltotalcost').html('');
                            $row.find('.complexCustadditionalunitcost').val('');
                            $row.find('.complexCustadditionaltotalcost').val('');
                        }
        ...
        <%--script for ebooks apps for complex ebookapps calc start--%>
         <script type="text/javascript">
             function complexebookappscalculation() {
                 var count = 0;
                 var productprice = 0;
                 var customisationprice = 0;
                 var cartprice = 0;
                 count = complexproductcount();
                 if (count > 0) {
                     productprice = complexproductcost();
                     customisationprice = getcomplexcustomisation();
                     cartprice = (parseFloat(productprice) + parseFloat(customisationprice)).toFixed(2);
                     $('.complexpackagecost').val(cartprice);
                     $('#imgbtncomplexproceed').prop('disabled', false);
                 }
                 else {
                     $('.complexpackagecost').val('');
                     clearcomplexcustomizations();
                     $('#imgbtncomplexproceed').prop('disabled', true);
                     $('input').val('');
                 }
             }
        </script>
        <%--script for ebooks apps for complex ebookapps calc complete--%>

         <%--script for to clear labels start--%>
        <script type="text/javascript">
            function clearcomplexcustomizations() {
                $('.complex_customize_products tr').each(function (i, row) {
                    var $row = $(row);
                    $row.find('.complexCustadditional').html('');
                    $row.find('.complexCustadditionalunitcost').html('');
        ...
        <%--complex ebookapps jquery calculation portion complete--%>
