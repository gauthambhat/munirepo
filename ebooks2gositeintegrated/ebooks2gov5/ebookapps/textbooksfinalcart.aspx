...
<body>
                ...
                <tr>
                    <td colspan="5" align="right">
                        <asp:ImageButton ID="Imgbtnback" runat="server" ImageUrl="../images/btnBack.jpg" 
                            PostBackUrl="~/ebooks2gov5/ebookapps/flupload.aspx?ID=5" />
                        &nbsp; &nbsp;
                        <asp:ImageButton ID="imgbtncheckout" runat="server"    OnClick="imgbtncheckout_Click" src="images/checkout_btn.jpg" width="117" height="30" alt="check out" /></td>
                </tr>
    ...
    <div id="modal_dialog" style="display: none;height:320px; width:800px;">
        <iframe id="Iframe2" runat="server" src="../../ebooks2gov5/signin/signin.aspx?ID=5" style="height:320px; width:380px;" noresize="noresize" frameborder="0" scrolling="no" border="0" />
    </div>
