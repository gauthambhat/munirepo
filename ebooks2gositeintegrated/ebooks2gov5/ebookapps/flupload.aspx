<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="flupload.aspx.cs" Inherits="eBooks2goV5.ebookapps.flupload" %>
          ...
          <ajax:CalendarExtender ID="ceflcompletedate" runat="server" TargetControlID="txtprojectdate" PopupButtonID="imgbtnflcompletedate" PopupPosition="BottomLeft"></ajax:CalendarExtender>--%>
                ...
                <tr class="eb2g_numberofmanuscripts">
                        <td colspan="3" align="right">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:ImageButton ID="imgbtnback" ImageUrl="~/ebooks2gov5/images/btnBack.jpg"  ImageAlign="Right" Style="margin-right: 20px;" runat="server" />
                        </td>
                    </tr>
